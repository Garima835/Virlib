...
const LibraryShelves = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "https://images.unsplash.com/photo-1575220360526-be964710f279?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" }}
      >
        ...
        <div className="footer-content">
          ...
          <div className="footer-links">
            <button onClick={handleAbout} className="footer-link">
              <i className="fas fa-ankh"></i><strong> About</strong>
            </button>
            <button onClick={handleContact} className="footer-link">
              <i className="fas fa-quill"></i><strong> Contact </strong>
            </button>
            <button onClick={handleHelp} className="footer-link">
              <i className="fas fa-infinity"></i><strong> Help </strong>
            </button>
          </div>
          <p className="hours">
