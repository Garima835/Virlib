  ...
  return (
    <div className="wrapper">
      <div className="form-1">
        ...
        <button onClick={() => handleRoleClick("admin")}>Login Now</button>
      </div>
      ...
      <div className="form-1">
        ...
        <button onClick={() => handleRoleClick("reader")}>Login Now</button>
      </div>
      ...
      <div className="form-1">
        ...
        <button onClick={() => handleRoleClick("author")}>Login Now</button>
      </div>
    </div>
  );
};
